...
public class Villa extends Facility{
    ...
    public Villa(String id, String name, double areaUsed, int price, int maximumPeople, String rentType, String standardRooms, double areaPool, int numberOfStoreys) {
